...
| `saha.jpg` | Slayt 7, Competition Manual kartlarının üstünde | Turnuva sahası, maç anı |
| `robot.jpg` | Slayt 15, beş yapı sistemi kartlarının üstünde | Takımın robotu ya da masadaki parçalar |
| `atolye.jpg` | Slayt 22, canlı topluluk kartlarının üstünde | Atölyede çalışan takım |
| `takim.jpg` | Slayt 26, kapanışın arka planı (soluk) | Geniş takım fotoğrafı, yatay |
| `diagram.webp` | Slayt 17, elektronik dokümanları kartlarının üstünde | Kontrol sistemi bağlantı şeması; kırpılmadan beyaz zeminde gösterilir |
