...
export const RESOURCES = [
  ...
  },
  {
    ...
    kind: 'kalici',
    star: true,
    desc: "FRC ve FTC için ücretsiz hesaplayıcı: kayış, zincir, dişli, lineer mekanizma, flywheel, motor karşılaştırma. Her hesabın paylaşılabilir adresi var; ekiple aynı sayfaya bakarsınız.",
  ...
  },
  {
    ...
    roles: ['mekanik'],
    kind: 'kalici',
    desc: "SDP-SI'nin Elements of Metric Gear Technology el kitabı: dişli hesabının endüstriyel referansı. KHK'nın Gear Knowledge sayfası (khkgears.net) aynı bilgiyi üretici gözüyle anlatıyor.",
    url: 'https://sdp-si.com/resources/elements-of-metric-gear-technology/index.php',
  },
  {
    ...
    roles: ['mekanik'],
    kind: 'kalici',
    desc: 'Oyun parçası ve alt sisteme göre düzenlenmiş mekanizma video kataloğu; Türkçe arayüzü var. Fikir ararken ilk durak. Tasarım ilkeleri için NASA RAP Robotics Design Guide (robotics.nasa.gov).',
...
/**
 * Ödüller ve karşılık geldikleri roller — slayt 19 ve sayfadaki Roller bölümü.
...
/**
 * Bu sezon ne değişti — slayt 7 ve 18. Kaynak: BIOBUZZ Competition Manual
...
export const CHANGES = {
  ruh: {
    ...
    after: '<b>Niyet edilen oyun</b> esas. Kural ruhunu anlatıyor; hakem ve gönüllü <b>iyi niyetli karar</b> veriyor. Her olayı tek tek tutanağa geçirmek yerine büyük resme bakılıyor.',
  ...
  evergreen: {
    ...
    after: '<b>Kalın yeşil ve başında *</b> olan kurallar evergreen: yıldan yıla aynı, yalnızca oyuna özel detay değişir. <b>Bir kez öğrenin, dört yıl kullanın.</b>',
  },
  robot: {
    tag: 'Robot kuralları',
    ...
    after: 'Öneriler manual\'dan çıktı, <b>eğitim kaynaklarına taşındı</b>. Benzer kurallar birleştirildi, bölüm yeni Section 1\'e göre yeniden düzenlendi. <b>18 inç küp aynen duruyor.</b>',
  },
  inspection: {
    tag: 'Inspection',
    ...
    after: 'Bu maddeler kaldırıldı; süreç artık <b>açıklama metninde</b> anlatılıyor. Kontrol listesi tam manual ile geliyor.',
  },
  interview: {
    tag: 'Jüri',
    ...
    after: 'Adı <b>Initial Interview</b> oldu; bölgeye ve etkinliğe göre jüri deneyimi farklılaşabilir. Takım jüri ödülleri için <b>katılmak şart</b>.',
  },
  portfolio: {
    tag: 'Portfolyo',
    ...
    after: 'Manual açıkça söylüyor: bazı ödüller için <b>PORTFOLIO teslimi ön koşul</b>. Hangi ödüller olduğu ödül tablosunda; portfolyo ekibi bunu ilk hafta işaretlesin.',
  },
  awards: {
    ...
    after: 'İkiye ayrıldı. <b>Reach:</b> FIRST\'e yeni insan kazandırma. <b>Sustain:</b> takımın uzun vadeli sürekliliği. Ödüller iki grupta: <b>TA</b> (Connect, Reach, Sustain) ve <b>MCI</b> (Design, Innovate, Control).',
  },
};
...
/** Bu haftanın görevleri — slayt 23. */
export const TASKS = [
...
/** Sipariş penceresi — slayt 14'teki uyarının sayısal hâli. */
export const SUPPLY = [
